// ignore_for_file: avoid_relative_lib_imports, prefer_const_declarations, prefer_const_literals_to_create_immutables, no_leading_underscores_for_local_identifiers, prefer_const_constructors
...
void main() {
  ...
  group('Watchlist', () {
    ...
    test('should execute remove watchlist when function called', () async {
      ...
      // act
      await provider.removeFromMovieWatchlist(testMovieDetail);
      // assert
