...
void main() {
  ...
  group('get Now Playing Movies', () {
    final tMovieList = MovieResponse.fromJson(
            json.decode(readJson('data/dummy_data/now_playing.json')))
        .movieList;
  ...
  group('get Top Rated Movies', () {
    ...
    test('should return list of movies when response code is 200 ', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/top_rated?$API_KEY')))
          .thenAnswer((_) async =>
              http.Response(readJson('data/dummy_data/top_rated.json'), 200));
      // act
  ...
  group('get movie detail', () {
    ...
    final tMovieDetail = MovieDetailResponse.fromJson(
        json.decode(readJson('data/dummy_data/movie_detail.json')));

    test('should return movie detail when the response code is 200', () async {
      // arrange
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/$tId?$API_KEY')))
          .thenAnswer((_) async => http.Response(
              readJson('data/dummy_data/movie_detail.json'), 200));
      // act
  ...
  group('get movie recommendations', () {
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('data/dummy_data/movie_recommendations.json'), 200));
      // act
  ...
  group('search movies', () {
    final tSearchResult = MovieResponse.fromJson(json
            .decode(readJson('data/dummy_data/search_spiderman_movie.json')))
        .movieList;
    ...
    test('should return list of movies when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('data/dummy_data/search_spiderman_movie.json'), 200));
      // act
